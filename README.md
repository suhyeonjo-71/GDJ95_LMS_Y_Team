...
강의 관리, 과제 제출, 출석 및 성적 산출 등 학사 운영에 필요한 주요 프로세스를 다루는 대학 LMS 플랫폼입니다.[cite: 1] 과제 점수와 출석 데이터를 기반으로 최종 성적이 자동으로 집계·갱신되는 데이터 정합성 중심의 구조를 구현하였습니다.
...
- 🔗 **[핵심 구현 코드 파일 보기](https://github.com/suhyeonjo-71/GDJ95_LMS_Y_Team)**
